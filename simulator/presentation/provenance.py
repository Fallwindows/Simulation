...
def schema_catalog() -> dict[str, Any]:
    return {
        ...
        "complete_bundle": {
            ...
            "required_rgb_source_bindings": [
                "view_video_sha256",
                "frame_index_sha256",
                "required_source_frame_end_exclusive",
                "postroll",
            ],
            "frame_540_sampling": {
                "outgoing": "contiguous RGB source frames 531-548 with observed stamps",
                "postroll": "source frames 540-548",
                "incoming": "nine cloned technical start frames; measurement time unavailable without producer mapping",
                "classification": "editorial temporal blend; not co-timed and not sensor/geometry fusion",
            },
            "technical_views": [
