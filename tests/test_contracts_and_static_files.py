...
class ContractTests(unittest.TestCase):
    ...
    def test_offline_slam_cli_probes_are_bounded_and_replay_is_lidar_only(self):
        ...
        self.assertIn('@("service","call","/rtabmap/pause","std_srvs/srv/Empty")', launcher)
        self.assertNotIn('/rtabmap/backup', launcher)
        self.assertNotIn('Copy-Item -LiteralPath $databaseBackup', launcher)
