...
TOPICS = ["/clock", "/sim/camera/rgb/image_raw", "/sim/lidar/points", "/tf", "/tf_static"]
TOPIC_TYPES = {
...
def build_complete_fixture(root: Path, repo_root: Path, ffmpeg: str, ffprobe: str) -> dict[str, Path]:
    ...
    write_json(camera_info, {
        "schema_version": 1, "provenance": "configured_intrinsics", "observed_ros_message": False,
        "source": "sensor_transforms.json", "topic": "/sim/camera/rgb/camera_info", "frame_id": "camera_optical_frame",
        "model": "ideal_pinhole", "width_px": 1920, "height_px": 1080, "fx_px": 960.0, "fy_px": 960.0,
        "cx_px": 959.5, "cy_px": 539.5,
    })
    ...
    capture_value = {
        ...
        "bag": {
            "uri": "sensors_bag", "storage_id": "sqlite3", "topics": TOPICS, "topic_types": TOPIC_TYPES,
        ...
        "rgb": {
            ...
            "camera_info_provenance": "configured_intrinsics", "metadata": metadata.name,
    ...
    technical_catalog_value = {
        "schema_version": 1, "status": "reviewed_source_catalog", "sources": [{
            ...
            "artifacts": {
                ...
                "trajectory": {"path": "slam/slam_poses.csv", "sha256": digest("trajectory"), "version": "fixture-trajectory-v1"},
    ...
    for view_id, role, frame_count, color in VIEWS:
        ...
        receipt = {
            ...
            "derivation": {"storyboard_pixels_consumed": False},
        }
