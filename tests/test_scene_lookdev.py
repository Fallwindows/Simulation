...
class SceneLookdevTests(unittest.TestCase):
    ...
    def test_legacy_pizza_front_reflection_is_bounded_and_idempotent(self):
        ...
        pizzas = [
            ...
            if asset.asset_key == "frozen_pizza"
        ]
        self.assertTrue(any("/r0/" in asset.semantic_id for asset in pizzas))
        self.assertTrue(any("/r1/" in asset.semantic_id for asset in pizzas))
        for asset in pizzas:
