...
- These source/test results do not claim visual acceptance or production delivery. The fresh current-scene capture, SLAM, and perception passes are complete. The independently reviewed 720p LiDAR preview is available; seven final 1080p technical clips and the 1,350-frame final film remain open. Generated runs and temporary review scratch are kept out of Git.
