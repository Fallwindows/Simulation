...
OUTPUT_PATH = EVIDENCE_DIR / "before_rgb_t008000ms.png"
RECORD_PATH = EVIDENCE_DIR / "before_rgb_t008000ms.json"
...
def main() -> None:
    ...
    try:
        ...
        pngs = sorted(EVIDENCE_DIR.glob("before_rgb_t008000ms.png"))
        if pngs != [OUTPUT_PATH]:
